...
namespace PMD
{
    public class PMD_USB_Device : IPMD_Device
    {
        ...
        public PMD_USB_Device(string port, int speed = 1)
        {
            ...
            Sensors = new List<Sensor>() {
                new Sensor("Total Power", "POWER", power_format, "W"), new Sensor("GPU Power", "GPU", power_format, "W"), new Sensor("CPU Power", "CPU", power_format, "W"),
